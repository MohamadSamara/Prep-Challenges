...
const objLat = (obj) => {
    ...
    let newFirstName = obj.firstName.charAt(0).toUpperCase()+obj.firstName.slice(1) ;
    let newLastName = obj.lastName.charAt(0).toUpperCase()+obj.lastName.slice(1);
...
const applicationsStatics = (arr) => {
    for (let i = 0; i < arr.length; i++) {
        if(arr[i].yearsOfExperience <= 1 || arr[i].tech == "" || arr[i].tech == null ){
